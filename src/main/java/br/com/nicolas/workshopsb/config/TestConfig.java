...
public class TestConfig implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    Order o1 = new Order(null, null, OrderStatus.PAID, u1);
    Order o2 = new Order(null, null, OrderStatus.WAITING_PAYMENT, u2);
    Order o3 = new Order(null, null, OrderStatus.WAITING_PAYMENT, u1);
